...
SHA, on a clean tree, with the fake-model extraction fixtures
...
evals and Steve's acceptance pass. Exit 0 from the driver means the six
cases are still driveable and complete; it is not a passing gate.
